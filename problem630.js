...
{
    let t = T();
    let pt1 = t.next().value;
    let pt2 = t.next().value;
    let pt3 = t.next().value;

    assert.equal(pt1.x, 527);
    assert.equal(pt1.y, 144);
    assert.equal(pt2.x,-488);
    assert.equal(pt2.y, 732);
    assert.equal(pt3.x,-454);
    assert.equal(pt3.y,-947);
}
